                                                                  ...
                                                                  <tbody>
                                                                     <tr>
                                                                        <td align="center" width="100%" style="padding: 0 15px;text-align: justify;color: #666666;font-size: 18px;line-height: 18px;">
                                                                           <h3 style="color: #666666; font-weight: 600; padding: 0px; margin: 0px; font-size: 48px; line-height: 30px; text-align: center;" class="title-color">Hi {{$user['name']}}!!!</h3>
                                                                           <p style="margin: 20px 0 5px 0;font-size: 15px; text-align:center;"><b>Welcome new user, I hope you like the task list!!</b></p>
                                                                           <p style="text-align:center;"><a class="link-color" style="text-decoration:none; " href="{{ env('APP_URL') }}'/dashboard'">Link</a></p>    
                                                         ...
                                                         <tr>
                                                            <td align="center" style="padding:20px 0 10px 0">
                                                               <table border="0" cellspacing="0" cellpadding="0" style="font-weight:400;font-family:Helvetica,Arial,sans-serif" width="100%">
                                                                  <tbody>
                                                                     <tr>
                                                                        <td align="center" width="100%" style="padding: 0 15px;text-align: justify;color: #0d0a078c;font-size: 18px;line-height: 18px;">
                                                                           <h3 style="font-weight: 600; padding: 0px; margin: 0px; font-size: 16px; line-height: 24px; text-align: center;" class="title-color"></h3>
                                                                           <p style="margin:0px; font-size: 10px;text-align: center;">name:</p>
                                                                           <p style="margin: 2px 0 2px 0;font-size: 12px;text-align: center;">{{$user['name']}}</p>
                                                                           <p style=" margin:0px;  font-size: 10px;text-align: center;">mail:</p>
                                                                           <p style="margin: 2px 0 2px 0;font-size: 12px;text-align: center;">{{$user['mail']}}</p>                                                                                
                                                                           <p style="margin: 0px 0 5px 0;font-size: 20px;text-align: center;"></p>                                                                                                                           
                                                                        </td>
                                                                     </tr>
                                                                  </tbody>
                                                               </table>
