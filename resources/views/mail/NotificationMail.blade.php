                                                                  ...
                                                                  <tbody>
                                                                     <tr>
                                                                        <td align="center" width="100%" style="padding: 0 15px;text-align: justify;color: #0d0a078c;font-size: 18px;line-height: 18px;">
                                                                           <h3 style="font-weight: 600; padding: 0px; margin: 0px; padding:2rem; font-size: 20px; line-height: 24px; text-align: center;" class="title-color">{{$data['task']}}</h3>
                                                                           <p style="margin:0px; font-size: 16px;text-align: center;">dateTime:</p>
                                                                           <p style="margin: 2px 0 2px 0;font-size: 20px;text-align: center;">{{$data['dateTime']}}</p>
                                                                           <p style="margin:0px; font-size: 16px;text-align: center;">category:</p>
                                                                           <p style="margin: 2px 0 2px 0;font-size: 20px;text-align: center;">{{$data['category']}}</p>
